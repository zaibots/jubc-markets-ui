...
export const APP_CODE_PER_SWAP_TYPE: Record<SwapType, string> = {
  [SwapType.Swap]: 'zaibots-v3-interface-widget',
  [SwapType.CollateralSwap]: 'zaibots-v3-interface-collateral-swap',
  [SwapType.DebtSwap]: 'zaibots-v3-interface-debt-swap',
  [SwapType.RepayWithCollateral]: 'zaibots-v3-interface-repay-with-collateral',
  [SwapType.WithdrawAndSwap]: 'zaibots-v3-interface-withdraw-and-swap',
};
